...
def match_employees(pat, name, overview, duration, goals, skillset, desired_outcomes, sign_of_completion):
    ...
    [Desired Outcome], [Project Completion]. The report must follow the [OUTPUT STRUCTURE]. [/TASK]
    ...
    prompt = PromptTemplate(template=template, input_variables=['name_input', 'overview_input', 'duration_input',
                                                                'goals_input', 'skillset_input', 'outcome_input', 'completion_input'])
    ...
    inputs = {'name_input': name, 'overview_input': overview, 'duration_input': duration, 'goals_input':goals,
              'skillset_input': skillset, 'outcome_input': desired_outcomes, 'completion_input':sign_of_completion}
