...
Это приложение подбирает сотрудников по описанию проекта
"""
...
if st.button('Match employees to this project'):
    summary, reasoning, evaluation = match_employees(name, overview, duration, goals, desired_outcomes, sign_of_completion)
    # st.write(summary)
    # st.write(reasoning)
    # st.write(evaluation)
    print(summary)
